...
class AdminCreate extends React.Component {
  ...
  async submit() {
    ...
    formData.role = role;
    let response = await axios.post(`${Config.API_URL_2}/cms/admin`, formData, { headers: { token: this.state.admin.token } });
    try {
          ...
          <div className="title d-flex flex-column flex-md-row">
            <div className="flex-grow-1 align-self-center">
              <div className="left d-flex">
                ...
                <div className="text flex-grow-1 align-self-center">Tambah Admin</div>
              </div>
            </div>
          </div>
        </div>
